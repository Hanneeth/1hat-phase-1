...
SCHEMA_TEMPLATE = """{
  ...
  "admission": {
    ...
    "package_booked": "<string or null — PM-JAY package code if present>",
  ...
  "documents_submitted": [
    ...
    {
      "key": "pre_anesthesia_check_up_report",
      "label": "Pre-anesthesia Check-up Report",
      "available": false
    },
    {
      "key": "post_treatment_clinical_photograph",
      "label": "Post-treatment Clinical Photograph",
      "available": false
    },
    {
      "key": "blood_test_cbc_sr_creatinine_platelet_etc",
      "label": "Blood Test (CBC, Sr. Creatinine, Platelet, etc.)",
      "available": false
    },
    {
      "key": "x_ray",
    ...
    {
      "key": "other_diagnostic_reports",
      "label": "Other Diagnostic Reports",
      "available": false
    }
  ],
