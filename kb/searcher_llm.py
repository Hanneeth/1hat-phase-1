...
def search_candidates(
    ...
    SYSTEM_PROMPT = (
        ...
        "- Be inclusive at this stage — include any procedure that could plausibly "
        "apply. A downstream clinical validation step will perform strict eligibility "
        "checking. Do not filter by TBSA ranges, severity grades, or clinical "
        "thresholds here — that is done later.\n"
        ...
        "under that package. Do not pre-select a single variant — downstream "
        "validation will determine the correct one.\n"
        "- Return between 5 and 20 procedure codes. Never return more than 30.\n"
